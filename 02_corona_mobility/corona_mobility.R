...
google_mobility %>% 
  ...
  labs(title = "Mobilitet i Danmark under COVID-19",
       subtitle = "Procentuel difference i mobilitet ift. median opgjort for perioden 3. januar til 6. februar 2020.<br/>
       Stiplede linjer markerer pressemøder om <span style='color:#CC1F1A'>nedlukning</span> og 
       <span style='color:#1F9D55'>genåbning</span> af Danmark.",
...
apple_mobility %>% 
  ...
  labs(title = "Mobilitet i Danmark under COVID-19",
       subtitle = "Procentuel difference i mobilitet ift. den 13. januar 2020.<br/>
       Stiplede linjer markerer pressemøder om <span style='color:#CC1F1A'>nedlukning</span> og 
       <span style='color:#1F9D55'>genåbning</span> af Danmark",
...
google_mobility %>% 
  ...
  labs(title = "Mobilitet i danske regioner under COVID-19",
       subtitle = "Procentuel difference i mobilitet ift. median opgjort for perioden 3. januar<br/>til 6. februar 2020.
